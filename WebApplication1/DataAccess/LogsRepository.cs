...
namespace WebApplication1.DataAccess
{
    public class LogsRepository
    {
        ...
        {
            var logId = "BF_v1_logs"; //a log id which you can invent to identify/distinguish your logs
            var client = LoggingServiceV2Client.Create();
            LogName logName = new LogName("programmingforthecloudbf", logId);  //your project id
